...
export async function customKeygenfnMove(key: string, path: string, type: 'seedPhrase' | 'privateKey') {
...
export async function customKeygenfnSolana(key: string, path: string, type: 'seedPhrase' | 'privateKey') {
...
export async function customKeygenfnSui(key: string, path: string, type: 'seedPhrase' | 'privateKey') {
...
export function getChainInfosList(
  ...
  const isSolanaPrivateKey = walletType === 'privateKey' && key && validateSolanaPrivateKey(key).isValid;
