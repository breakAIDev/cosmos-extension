...
export const REMOVED_CHAINS_FROM_ONBOARDING = ['iov-mainnet-ibc', 'odin-mainnet-freya', 'gravity-bridge-3', '1'];
...
export const SEI_EVM_LEDGER_ERROR_MESSAGE = 'Transactions for EVM addresses are not supported on Ledger yet';
