...
export const SwapActionFailedSection = observer(({ transferAssetRelease, rootDenomsStore }: Props) => {
  ...
  const { data: denomInfo, isLoading: isLoadingDenomsInfo } = useDenomData(denom, chainID, rootDenomsStore.allDenoms);
