...
export function TxStepsStatusIcon({
  ...
  return (
    <div className='relative rounded-full w-9 h-9 bg-gray-100 dark:bg-gray-850 flex flex-row justify-center items-center gap-2'>
      ...
      {isCompleted && (
        <div
          className={classNames('rounded-full w-5 h-5 text-white-100 flex flex-row justify-center items-center', {
      ...
      {isPending && (
        <>
          ...
          <img
            src={theme === ThemeName.DARK ? Images.Loaders.SwapsStepsLoaderDark : Images.Loaders.SwapsStepsLoader}
