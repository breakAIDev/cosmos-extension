...
export const TxPageSteps = observer(({ routingInfo, txStatus, rootDenomsStore }: TxPageStepsProps) => {
                ...
                <TxPageStepsType
                  ...
                  response={
                    txStatus?.[txIndex]?.responses?.[
                      routingInfo.aggregator === RouteAggregator.MOSAIC ? actionIndex : transferSequenceIndex
                    ]
                  }
