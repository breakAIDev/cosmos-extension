...
export default function useAssets() {
  ...
  const allSkipAssets: Record<string, SkipSupportedAsset[]> | Record<string, MosaicSupportedAsset[]> | undefined =
    isSkipEnabled ? Object.assign({}, _allSkipAssets, _mosaicAssets?.assets) : undefined;
