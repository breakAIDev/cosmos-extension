...
export const CastVote = observer(
  ({
    ...
    const { loading, vote, error, memo, setMemo, feeText, showLedgerPopup, clearError, ledgerError } = useGov({
      denoms,
      proposalId,
    ...
    }, [activeChain, gasLimit, feeDenom.coinMinimalDenom, gasPriceOption.option, nativeFeeDenom?.coinMinimalDenom]);
