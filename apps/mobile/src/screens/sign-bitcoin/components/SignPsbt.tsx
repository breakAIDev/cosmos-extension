  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className={`px-7 py-3 overflow-y-auto relative ${isRedirected ? 'h-[500px]' : 'h-[450px]'}`}>
            ...
            {details?.txAmount ? (
              <p className='mt-3'>
                <span className='font-semibold text-gray-900 dark:text-white-100 pl-1'>Amount</span>
            ...
            {details?.fee ? (
              <p className='mt-3'>
                ...
                <pre className='text-xs text-gray-900 dark:text-white-100 dark:bg-gray-900 bg-white-100 p-4 w-full overflow-x-auto rounded-2xl mt-1'>
                  {`${new BigNumber(Number(details.fee)).dividedBy(10 ** (denomInfo.coinDecimals ?? 8)).toNumber()} ${
                    chainInfo.denom
                  }`}
                </pre>
              </p>
            ...
            {details?.inputs?.length ? (
              <p className='mt-3'>
                <span className='font-semibold text-gray-900 dark:text-white-100 pl-1'>Inputs</span>
            ...
            {details?.outputs?.length ? (
              <p className='mt-3'>
                <span className='font-semibold text-gray-900 dark:text-white-100 pl-1'>Outputs</span>
