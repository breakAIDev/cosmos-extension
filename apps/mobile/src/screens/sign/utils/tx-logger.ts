...
import { getEip712TxHash, getMsgFromAmino, getTxHashFromSignedTx, SupportedChain } from '@leapwallet/cosmos-wallet-sdk';
import {
  initiaAminoConverters,
  initiaProtoRegistry,
} from '@leapwallet/cosmos-wallet-sdk/dist/browser/proto/initia/client';
import { createTransaction, SIGN_AMINO } from '@leapwallet/cosmos-wallet-sdk/dist/browser/proto/injective/core/modules';
import {
...
> = {
  ...
  '/ibc.applications.transfer.v1.MsgTransfer': {
    ...
    toAmino: ({ sourcePort, sourceChannel, token, sender, receiver, timeoutHeight }: MsgTransfer) => ({
 ...
 */
export function getTxHashFromAminoSignResponse(data: AminoSignResponse, pubkey: Uint8Array): string {
  const signedTxBody = {
