...
const OnboardingImportWalletView = () => {
  ...
  return (
    <AnimatePresence mode='wait' presenceAffectsLayout>
      ...
      {currentStepName === 'select-ledger-network' && <SelectLedgerNetwork key={'select-ledger-network-view'} />}

      {currentStepName === 'import-watch-wallet' && <ImportWatchWallet key={'import-watch-wallet-view'} />}
      ...
      {currentStepName === 'select-ledger-wallet' && <SelectLedgerWallet key={'select-ledger-wallet-view'} />}
