...
const _ManageAuthZ = observer(({ isVisible, onClose }: { isVisible: boolean; onClose: () => void }) => {
...
export const ManageAuthZ = observer(({ isVisible, onClose }: { isVisible: boolean; onClose: () => void }) => {
  return (
