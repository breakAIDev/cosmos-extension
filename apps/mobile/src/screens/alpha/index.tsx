...
export default function Alpha() {
  ...
  return (
    <>
      ...
      {activeTab === 'all' ? (
        <BookmarkedAlpha isOpen={showBookmarks} toggler={() => params.remove(queryParams.alphaBookmarks)} />
      ) : (
        <BookmarkedChad isOpen={showBookmarks} toggler={() => params.remove(queryParams.alphaBookmarks)} />
      )}

      <AlphaDetailsDrawer isShown={showDetails} onClose={closeDetails} opportunity={selectedOpportunity} />

      <RaffleDetailsDrawer isShown={showChadDetails} onClose={closeChadDetails} raffle={selectedChadOpportunity} />
