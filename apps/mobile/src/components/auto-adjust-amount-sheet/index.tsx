  ...
  return (
    ...
    >
      <p className="text-gray-200 font-medium mb-6">
        Confirming this transaction may leave you with insufficient{' '}
        {nativeDenom?.coinDenom ?? ''} balance for future transaction fees.
      </p>

      <div className="rounded-2xl p-4 dark:bg-gray-900 bg-gray-50 mb-6">
        <p className="text-sm text-white-100 font-bold mb-4">
        ...
        <div className="flex items-center rounded-xl p-4 dark:bg-gray-850 bg-gray-100 gap-4">
          ...
          <div className="flex-1 text-sm text-green-500 font-bold">
...
> = ({
  ...
  return (
    ...
    >
      <p className="text-gray-200 font-medium mb-6">
        You seem to have insufficient {nativeDenom?.coinDenom ?? ''} balance to
...
export const AutoAdjustAmountSheet = observer(
  ({
    ...
    const nativeDenom = useMemo(() => {
      ...
      const key = getKeyToUseForDenoms(
