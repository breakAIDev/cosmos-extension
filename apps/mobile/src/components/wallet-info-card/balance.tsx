...
export const getCosmosBalance = async (address: string) => {
  try {
    ...
    const atomDetails = result.data.balances.find(
...
export const getCelestiaBalance = async (address: string) => {
  try {
    ...
    const celDetails = result.data.balances.find(
      balance => balance.denom === 'ucel',
    );
...
export const getBitcoinBalance = async (address: string) => {
  ...
  try {
    const bitcoinBalanceStore = new BitcoinBalanceStore(
      rpcUrl,
      address,
      'bitcoin',
    );
