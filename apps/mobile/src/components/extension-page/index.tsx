...
export default function ExtensionPage(
  props: PropsWithChildren<ExtensionPageProps>,
) {
  const { titleComponent, children, headerRightComponent, childrenMargin } =
    props;
    ...
    >
      ...
      <div
        className={classNames(
          'flex z-10 overflow-scroll items-start justify-center',
          {
            ...
            {!headerRightComponent && (
              <div className="absolute right-0 flex flex-row gap-x-[8px] z-20">
                <IconButton
                  ...
                  image={{
                    src: isDark
                      ? Images.Misc.LightTheme
                      : Images.Misc.DarkTheme,
                    alt: 'Back',
                  }}
                />
