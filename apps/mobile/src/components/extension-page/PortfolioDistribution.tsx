...
function _PortfolioDistribution({
  ...
  const walletBalancePct = walletBalance
    ?.times(100)
    .div(totalBalance as BigNumber);
  ...
  return (
    <div className="rounded-2xl dark:bg-gray-900 bg-white-100 mb-2">
      <div className="flex justify-between">
        <Text
          size="sm"
          color="dark:text-gray-200 text-gray-600 font-medium px-5 pt-4"
        >
