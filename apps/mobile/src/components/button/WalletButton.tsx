    ...
    return (
      ...
      >
        <button
          className={classNames(
            'flex items-center justify-center gap-2 py-[6px] pl-[12px] pr-[2px]',
            {
              ...
              'border-r-[1px] border-solid border-gray-100 dark:border-gray-850':
                giveCopyOption,
            },
          )}
        ...
        {giveCopyOption ? (
          <button
            className={classNames(
              'flex items-center justify-center px-[10px] py-[8px]',
              {
        ...
        {isAddressCopied && (
          ...
          >
            ...
            <span className="text-white-100 text-[14px] font-bold">
              Copied!
            </span>
          </motion.div>
        )}
