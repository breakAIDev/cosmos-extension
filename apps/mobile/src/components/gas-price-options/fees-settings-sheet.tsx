...
export const FeesSettingsSheet: React.FC<FeesSettingsSheetProps> = ({
  ...
  const { setViewAdditionalOptions, viewAdditionalOptions } =
    useGasPriceContext();
    ...
    >
      ...
      >
        <p className="text-sm font-medium text-secondary-800">
          Transaction fee is charged by the network. Higher the transaction fee,
          faster the transaction will go through.
        </p>
