...
export const getNomicBTCDepositConstants = (storage: storage): Promise<NomicBTCDepositConstants> => {
  return cachedRemoteDataWithLastModified({
    remoteUrl: 'https://assets.leapwallet.io/cosmos-registry/v1/nomic-btc-deposit/nomic-btc-deposit-constants.json',
