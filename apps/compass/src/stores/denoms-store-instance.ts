...
export const compassTokenTagsStore = new CompassTokenTagsStore(app, version, isCompassWallet(), denomsStore);

export const enabledCW20DenomsStore = new EnabledCW20DenomsStore(activeChainStore, addressStore, storageAdapter);

export const disabledCW20DenomsStore = new DisabledCW20DenomsStore(activeChainStore, addressStore, storageAdapter);
...
export const interactedDenomsStore = new InteractedDenomsStore(activeChainStore, addressStore, storageAdapter);
