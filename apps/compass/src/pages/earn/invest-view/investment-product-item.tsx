  ...
  return (
    <li className='!m-0 px-4 group/item'>
      ...
      >
        ...
        >
          <img src={productDapp.logo} onError={imgOnError(defaultLogo)} className='h-8 w-8' title={productDapp.name} />
        ...
        <p className={`flex-[1] text-center font-bold text-xs ${product.apr > 0 ? 'text-green-500' : 'text-red-300'}`}>
