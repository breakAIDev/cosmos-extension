...
export const SelectAggregatedActivityChain = observer(
  ({ isVisible, onClose, chainsToShow, selectedChain, onChainSelect }: SelectAggregatedActivityChainProps) => {
    return (
      <BottomModal isOpen={isVisible} onClose={onClose} title='Switch chain'>
        <ListChains selectedChain={selectedChain} onChainSelect={onChainSelect} chainsToShow={chainsToShow} />
      </BottomModal>
    );
  },
);
