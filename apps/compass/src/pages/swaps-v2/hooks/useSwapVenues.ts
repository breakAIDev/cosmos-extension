import { cachedRemoteDataWithLastModified, storage, useGetStorageLayer } from '@leapwallet/cosmos-wallet-hooks';
...
export async function getSwapVenues(storage: storage, isCompassWallet: boolean): Promise<Array<SwapVenue>> {
  try {
