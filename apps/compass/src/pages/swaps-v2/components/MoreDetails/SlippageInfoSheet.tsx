    ...
    >
      <div className='text-md !leading-[25.6px] font-medium text-gray-800 dark:text-gray-200 text-left'>
        ...
        <span className='text-black-100 dark:text-white-100 font-bold'>
          {formatTokenAmount(slippageAmount.toString(), destinationToken?.symbol)} ({slippagePercent}% slippage ~{' '}
        ...
        <span className='text-black-100 dark:text-white-100 font-bold'>{slippagePercent}%</span>, the swap will not take
        place and your funds will be refunded.
      </div>
    </BottomModal>
  );
}
