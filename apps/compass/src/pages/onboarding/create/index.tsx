...
const OnboardingCreateWalletView = () => {
  const { mnemonic, onOnboardingCompleted, moveToNextStep, currentStep, loading, prevStep } = useCreateWalletContext();
  ...
  return (
    <AnimatePresence mode='wait' presenceAffectsLayout>
      ...
      {currentStep === 2 && !loading && (
        <ConfirmSecretPhrase key='confirm-secret-phrase-view' mnemonic={mnemonic} onProceed={moveToNextStep} />
      )}
