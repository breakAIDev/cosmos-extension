              ...
              {mode === 'REDELEGATE' && (
                <div className='flex items-start gap-1.5 px-3 py-2.5 rounded-b-xl text-accent-blue bg-accent-blue-800'>
                  ...
                  <span className='text-xs font-medium'>
                    Sei enforces a 21-day wait period between redelegations. Once you have redelegated from one
                    validator to another, you must wait for 21 days before redelegating again further.
                  </span>
                </div>
              )}
            </div>
