  ...
  return (
    <div className='p-5 flex flex-col h-full'>
      ...
      <AnimatePresence mode='wait' presenceAffectsLayout>
        ...
        {processStep === 2 && (
          <RequireSeedPhrase key={'RequireSeedPhrase'} incrementStep={incrementStep} setMnemonicAtRoot={setMnemonic} />
        )}
        {processStep === 3 && (
          <SelectWallets
            key={'SelectWallets'}
        ...
        {processStep === 4 && <SetPassword key={'SetPassword'} resetPassword={onSubmit} loading={loading} />}
      </AnimatePresence>
    </div>
  );
});
