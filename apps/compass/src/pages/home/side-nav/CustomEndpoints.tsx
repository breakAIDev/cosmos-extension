...
export const SelectChainSheet = observer(
  ({ isVisible, onClose, onChainSelect, selectedChain, onPage, chainsToShow }: SelectChainSheetProps) => {
    return (
  ...
  return (
    <>
      <div className={'panel-height panel-width enclosing-panel flex flex-col flex-1'}>
        <Header title='Custom Endpoints' action={{ type: HeaderActionType.BACK, onClick: goBack }} />
        <div className='flex flex-col items-center p-5 flex-1 relative'>
          ...
          <div className='flex flex-col w-full mt-auto'>
            {validating && (
              <p className='font-bold text-gray-900 dark:text-gray-50 text-center mb-2'>Validating endpoints..</p>
            )}
