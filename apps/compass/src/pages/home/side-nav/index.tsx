  ...
  return (
    ...
    >
      ...
      >
        ...
        {!showNavPage && dropUp !== DropUps.GS && (
          <div className='flex flex-col [&>*]:shrink-0 h-full'>
            ...
            <div className='p-7 pt-2 overflow-scroll'>
              ...
              <Security setShowNavPage={setShowNavPage} openGSDropUp={() => setDropUp(DropUps.GS)} />
        ...
        <NetworkDropUp isVisible={dropUp === DropUps.NETWORK} onCloseHandler={() => setDropUp(undefined)} />
        {/* {showFinderDropUp && <FinderDropUp onCloseHandler={() => setShowFinderDropUp(false)} />} */}

        <ThemeDropUp isVisible={dropUp === DropUps.THEME} onCloseHandler={() => setDropUp(undefined)} />
      </DrawerContent>
    </Drawer>
  );
});
