...
const TxPage = observer(({ isOpen, onClose, txType }: { isOpen: boolean; onClose: () => void; txType: TxType }) => {
  ...
  return (
    ...
    >
      ...
      <div className=' flex flex-row items-center justify-between gap-4 absolute bottom-0 left-0 right-0 p-6 max-[350px]:!px-4 !z-[1000]'>
        <Button
          className={classNames(`w-1/2 bg-monochrome hover:bg-monochrome text-monochrome-foreground`)}
