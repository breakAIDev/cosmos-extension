...
export const V125_BETA_NFT_COLLECTIONS_MIGRATION_COMPLETE = 'v125-beta-nft-collections-migration-complete';
export const V151_NFT_SEPARATOR_CHANGE_MIGRATION_COMPLETE = 'v151-nft-separator-change-migration-complete';
