    ...
    buttonRingClass,
  {
    variants: {
      variant: {
        ...
        ghost: 'text-muted-foreground hover:text-foreground bg-transparent disabled:text-muted-foreground',
        action:
          'bg-accent-blue-700 hover:bg-accent-blue-600 disabled:bg-accent-blue-600/40 text-accent-blue-foreground gap-1',
        secondary: 'bg-secondary-100 hover:bg-secondary-200 disabled:bg-secondary-100/40 text-secondary-foreground',
        destructive:
