...
export function WalletInfoCardSkeleton(props: { className?: string }) {
  return (
    <div className={cn('flex flex-row gap-3 items-center p-5 w-full cursor-pointer select-none', props.className)}>
...
export function WalletInfoCardSkeletons({ cardClassName, count, ...props }: WalletInfoCardSkeletonsProps) {
  return (
    <div {...props}>
