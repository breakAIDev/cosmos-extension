...
export default function CanvasTextBox({ text, noSpace, size = 'lg' }: CanvasTextBoxProps): ReactElement {
  ...
  return (
    ...
    >
      <div className='flex flex-1 justify-center items-center h-full'>
        <CanvasBox height={textLength === 24 ? 288 : 144} width={widthMap[size] - 30} text={text} noSpace={noSpace} />
      </div>
