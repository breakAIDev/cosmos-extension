...
import FrogHappy from './leap-logo.png';
import FrogHappyWithBg from './leap-logo.png';
import FrogPanic from './leap-logo.png';
import FrogSad from './leap-logo.png';
import OnboardingFrog from './leap-logo.png';
