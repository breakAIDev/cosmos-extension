      ...
      <div className='flex flex-col gap-10 w-full p-2 !pt-6'>
        <div className='flex flex-col gap-4'>
              ...
              >
                <div
                  className={classNames(
                    ...
                    slippageRemarks.type === 'error' ? 'text-destructive-100' : 'text-accent-yellow',
                  )}
                >
          ...
          <Text color='dark:text-gray-400 text-gray-600' size='sm'>
            Your transaction will fail if the price changes more than the slippage. Too high of a value will result in
