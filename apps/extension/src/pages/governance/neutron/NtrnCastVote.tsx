...
import { FeeTokenData, GasOptions, TxCallback, useActiveChain, useNtrnGov } from '@leapwallet/cosmos-wallet-hooks';
...
function CastVoteSheet({
  ...
  return (
    <BottomModal isOpen={isOpen} onClose={onCloseHandler} title='Call your Vote' className='!pt-8 p-6'>
    ...
    return (
      <div className={classNames('', className)}>
        <GasPriceOptions
          ...
          setGasLimit={(gasLimit: number | string | BigNumber) => setUserPreferredGasLimit(Number(gasLimit.toString()))}
